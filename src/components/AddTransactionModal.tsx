        ...
        <View style={styles.conditionalField}>
          <Text style={styles.label}>Bénéficiaire *</Text>
            ...
            itemStyle={styles.pickerItem}>
              <Picker.Item  style={styles.dateText} label="Sélectionner un bénéficiaire" value="" />
              <Picker.Item  style={styles.dateText} label="Don a Dieu" value="Don ä Dieu" />
              <Picker.Item  style={styles.dateText} label="Allocations" value="Allocations" />
              <Picker.Item  style={styles.dateText} label="Don aux freres" value="Don aux freres" />
              <Picker.Item  style={styles.dateText} label="Epargnes" value="Epargnes" />
              <Picker.Item  style={styles.dateText} label="PNK" value="PNK" />
              <Picker.Item  style={styles.dateText} label="Autre" value="autre" />
          </Picker>
