...
type TimeGranularity = 'hour' | 'minute';
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.chartCard}>
        ...
        <Text style={styles.chartSubtitle}>Sorties et Entrées</Text>
        ...
        {/* Toggle Granularité Horaire - Afficher seulement pour 1D */}
{selectedPeriod === '1D' && (
  <View style={styles.granularityContainer}>
    <View style={styles.granularityButtons}>
      <TouchableOpacity
        onPress={() => setTimeGranularity('hour')}
        style={[
          styles.granularityButton,
          timeGranularity === 'hour' && styles.granularityButtonActive
        ]}
      >
        <Text style={[
          styles.granularityButtonText,
          timeGranularity === 'hour' && styles.granularityButtonTextActive
        ]}>
          Par heure
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        onPress={() => setTimeGranularity('minute')}
        style={[
          styles.granularityButton,
          timeGranularity === 'minute' && styles.granularityButtonActive
        ]}
      >
        <Text style={[
          styles.granularityButtonText,
          timeGranularity === 'minute' && styles.granularityButtonTextActive
        ]}>
          Par minute
        </Text>
      </TouchableOpacity>
      ...
      {/* Donut Chart */}
      <View style={styles.chartCard}>
        <Text style={styles.chartTitle}>Répartition : Sorties vs Entrées</Text>
        {renderDonutChart()}
